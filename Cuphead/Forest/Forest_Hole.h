...
class Forest_Hole : public IForestObjects
{
public:
	Forest_Hole() : Forest_Hole(Vector2(), 1.0f, 0.0f, 0) {}
	Forest_Hole(const Vector2& position, const float& totalSize, float rotation, bool bCollision);
